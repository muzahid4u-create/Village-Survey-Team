...
export const personInputSchema = z.object({
  ...
  otherCasteCategoryDetail: z.string().optional(),
  annualIncome: z.number().optional(),
  occupation: z.enum(["EMPLOYED", "AGRICULTURE", "HOUSE_WIFE", "BUSINESS", "STUDENT", "MINOR", "UNEMPLOYED", "OTHER"]).optional(),
  education: z.enum(["SCHOOL_GOING_CHILD", "LESS_THAN_10TH", "10TH", "12TH", "ITI", "DIPLOMA", "DEGREE", "MASTERS", "OTHERS"]).optional(),
...
export const householdBundleSchema = z.object({
  household: z.object({
    ...
    linkedHouseIds: z.string().optional(),
    ownershipPattern: z.enum(["SINGLE_HOUSE", "MULTIPLE_HOUSE_IDS", "HOUSE_AND_PLOT", "MULTIPLE_HOUSE_IDS_AND_PLOT"]).optional(),
